...
//	uint32_t temp;
	...
	input_config = 0x69;	//роллета неактивный, ступень активный
	//input_config = 0xA9;	//роллета неактивный, ступень неактивный
	//input_config = 0xA5;	//роллета активный, ступень неактивный
	//input_config = 0x65;	//роллета активный, ступень активный
